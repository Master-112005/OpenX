...
describe('File Management Automation', function() {
  ...
  it('should create a file on the desktop from a natural-language command', function() {
    const result = router.process('Create file report.pdf on desktop', 'chat');
  ...
  it('should delete a file from the desktop from a natural-language command', function() {
    const targetPath = path.join(tempProfile, 'Desktop', 'practice.java');
    fs.writeFileSync(targetPath, 'class Practice {}', 'utf8');

    const result = router.process('delete practice.java file from desktop', 'chat');
  ...
  it('should move a file between special folders', function() {
    ...
    const result = router.process('move notes.txt from desktop to downloads', 'chat');
  ...
  it('should move a file when the command includes a leading article', function() {
    ...
    const result = router.process('move the practice.java from desktop into downloads', 'chat');
  ...
  it('should create a folder on the desktop', function() {
    const result = router.process('create folder Projects on desktop', 'chat');
  ...
  it('should delete a folder from the desktop', function() {
    ...
    const result = router.process('delete folder Practice from desktop', 'chat');
  ...
  it('should move a folder between special folders', function() {
    ...
    const result = router.process('move folder Archive from desktop to documents', 'chat');
