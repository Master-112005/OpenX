...
const ALLOWED_TRANSITIONS = Object.freeze({
  [SPEECH_STATES.IDLE]: new Set([
    SPEECH_STATES.ACTIVATING,
    SPEECH_STATES.LISTENING,
    SPEECH_STATES.ERROR,
    SPEECH_STATES.RECOVERING
  ]),
  [SPEECH_STATES.ACTIVATING]: new Set([
    SPEECH_STATES.LISTENING,
    SPEECH_STATES.RESPONDING,
    SPEECH_STATES.IDLE,
    SPEECH_STATES.ERROR,
    SPEECH_STATES.THINKING,
  ...
  [SPEECH_STATES.TRANSCRIBING]: new Set([
    SPEECH_STATES.THINKING,
    SPEECH_STATES.RESPONDING,
    SPEECH_STATES.IDLE,
    SPEECH_STATES.ERROR
  ]),
  [SPEECH_STATES.THINKING]: new Set([
    SPEECH_STATES.RESPONDING,
    SPEECH_STATES.IDLE,
    SPEECH_STATES.ERROR
  ]),
  ...
  [SPEECH_STATES.RECOVERING]: new Set([
    SPEECH_STATES.IDLE,
    SPEECH_STATES.ERROR,
    SPEECH_STATES.RECOVERING
  ])
